...
通榆县商贸安全管理平台是一套基于Django和Vue3技术栈开发的政府监管信息管理平台，采用前后端分离架构，旨在为通榆县政府监管部门提供商户管理、检查任务中心、工单处理、督办中心等核心业务功能，实现监管工作的数字化、规范化和高效化。
...
**功能描述**: 对通榆县严重逾期工单进行统一筛选和督办中心，向监管单位发送正式督办通知。
...
**权限范围**:
- 拥有商户管理、任务中心、工单管理、督办中心等业务模块的完全访问权限
- 拥有数据中心和首页统计的查看权限
...
- 拥有督办中心的查看权限（根据数据权限范围）
- 拥有数据中心和首页统计的查看权限（根据数据权限范围）
- 拥有个人信息的修改权限
